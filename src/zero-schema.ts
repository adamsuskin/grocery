  ...
  tables: {
    ...
    grocery_items: {
      ...
      columns: {
        ...
        unit: { type: 'string' as const, optional: true },
        quantityDecimal: { type: 'number' as const, optional: true },
    ...
    unit_conversions: {
      tableName: 'unit_conversions' as const,
      primaryKey: ['id'] as const,
      columns: {
        id: { type: 'string' as const },
        fromUnit: { type: 'string' as const },
        toUnit: { type: 'string' as const },
        conversionFactor: { type: 'number' as const },
        category: { type: 'string' as const },
        notes: { type: 'string' as const, optional: true },
        createdAt: { type: 'number' as const },
      },
    ...
    user_preferences: {
      ...
      columns: {
        id: { type: 'string' as const },
        userId: { type: 'string' as const },
        preferredSystem: { type: 'string' as const },
        defaultVolumeUnit: { type: 'string' as const },
        defaultWeightUnit: { type: 'string' as const },
        displayFormat: { type: 'string' as const },
        autoConvert: { type: 'boolean' as const },
        createdAt: { type: 'number' as const },
        updatedAt: { type: 'number' as const },
      },
      relationships: {
        user: {
          source: 'userId' as const,
          dest: { field: 'id' as const, schema: () => schema.tables.users },
        },
      },
    },
  },
